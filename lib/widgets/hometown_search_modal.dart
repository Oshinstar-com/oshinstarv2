...
class HometownSearchModal extends StatefulWidget {
  const HometownSearchModal({Key? key}) : super(key: key);

  @override
  _HometownSearchModalState createState() => _HometownSearchModalState();
}

class _HometownSearchModalState extends State<HometownSearchModal> {
            ...
            ElevatedButton(
                onPressed: () async {
                  await AuthenticationApi.updateUser({
                    "userId": user["userId"],
                    "hometown": _controller.text
                  });
      
                  context
                      .read<UserCubit>()
                      .setUserInfo({"hometown": _controller.text ?? ""});
